...
# # First Star
# highest_seat_ID_seen = 0
# for boarding_pass in airplane:
#     min_row = 0
#     max_row = 127
#     for character in boarding_pass[:7]:
#
#         dist = max_row - min_row + 1
#
#         if character == 'F':
#             max_row -= dist // 2
#         elif character == 'B':
...
#
#     if seat_id > highest_seat_ID_seen:
#         highest_seat_ID_seen = seat_id
